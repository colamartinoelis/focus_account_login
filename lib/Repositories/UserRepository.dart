...
import 'package:focus/Model/UserModel.dart';
...
class UserRepository {
  ...
  Future<String> login(String email, String password) async {
    final response = await repository.http.post(LoginPage.routeName, bodyParameters: {
      "email": email,
      "password": password,
    });
  ...
  Future<String> register(
    ...
    final response = await repository.http.postMultipart(AccountPage.routeName, bodyParameters: {
      "name": name,
      "email": email,
      "password": password,
